"use client"
import { ValidateAccount } from "@/action/validateaccount-action";
...
export default function Page() {
    ...
    const { handleSubmit, reset, register, formState: { errors } } = useForm<ValidateAccountType>()
    ...
    return (
        <Formulario OnSubmit={handleSubmit((data) => mutate(data))}>
            <div className="flex flex-col dark:text-black">
                <label className="mb-1 font-semibold text-gray-700">Ingrese el token para activar su cuenta</label>
                <input
                    type="text"
                    disabled={isPending}
                    placeholder="000000"
